...
{
    /// <summary>
    /// A ScriptableObject variable that holds an int value at runtime.
    /// Implements ISaveable for persistence through the Save module.
    /// </summary>
    [CreateAssetMenu(menuName = "EventHorizon/Variables/Int Variable", order = 1)]
    public class IntVariableSO : VariableSO<int>, ISaveable
    {
        ...
        [System.Serializable]
        private struct SaveWrapper { public int Value; }
    }
}
