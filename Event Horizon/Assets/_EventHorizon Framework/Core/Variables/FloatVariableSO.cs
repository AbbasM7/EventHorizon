...
{
    /// <summary>
    /// A ScriptableObject variable that holds a float value at runtime.
    /// Implements ISaveable for persistence through the Save module.
    /// </summary>
    [CreateAssetMenu(menuName = "EventHorizon/Variables/Float Variable", order = 0)]
    public class FloatVariableSO : VariableSO<float>, ISaveable
    {
        ...
        [System.Serializable]
        private struct SaveWrapper { public float Value; }
    }
}
